...
local defaults = {
    ...
    normal_mode = {
        ...
        ["<Leader>\\"] = ":so ~/.config/nvim/init.vim<CR>",
        ["<Leader><Return>"] = ":e ~/.config/nvim/init.vim<CR>",
        ["<C-s>"] = ":update<CR>",
        ["<leader>bp"] = ":bprev",
        ["<leader>bn"] = ":bnext",
        ["<leader>t"] = ":tabedit term://zsh<CR>A",
        ["<leader>C"] = ":copen<CR>",
        ["<leader>pv"] = ":Vex<CR>",
        ["<leader>y"] = "+y",
        ["<leader>Y"] = "+yG",
        ...
        ["<leader>P"] = ":lua require('telescope.builtin').grep_string { search = vim.fn.expand(' < cword > ') }<CR>",
        ["<leader>p"] = ":lua require('telescope.builtin').grep_string()<CR>",
        ...
        ["<leader>vrc"] = ":lua require('cata.telescope').search_vim()<CR>",
        ["<leader>zsh"] = ":lua require('cata.telescope').search_zsh()<CR>",
        ["<leader>dot"] = ":lua require('cata.telescope').search_dotfiles()<CR>",
        ["<leader>cht"] = ":lua require('cata.telescope').search_cht()<CR>",
        ["<leader>vh"] = ":lua require('telescope.builtin').help_tags()<CR>",
        ["<leader>gw"] = ":lua require('telescope').extensions.git_worktree.git_worktrees()<CR>",
        ["<leader>gm"] = ":lua require('telescope').extensions.git_worktree.create_git_worktree()<CR>",
    },
